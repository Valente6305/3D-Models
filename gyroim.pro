PRO read_gyro_im, r, file=file

 IF ~keyword_set(file) THEN file='gyroim.out'
...
;print,mensa
 ...
 read_gyro_im, r; , file='/Users/usuario/Dropbox/programasidl/tratamento_norh/gyroim.in'
