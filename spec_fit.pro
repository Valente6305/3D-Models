; $Id: curvefit.pro,v 1.21 1999/01/16 01:22:27 scottm Exp $
;
; Copyright (c) 1982-1999, Research Systems, Inc.  All rights reserved.
;	Unauthorized reproduction prohibited.
;
FUNCTION SPEC_FIT, x, y, weights, a, sigma, FUNCTION_NAME = Function_Name, $
                        ITMAX=itmax, ITER=iter, TOL=tol, CHI2=chi2, $
                        NODERIVATIVE=noderivative, CHISQ=chisq,flag=flag
;+
; NAME:
;       SPEC_FIT
;
...
;
; CALLING SEQUENCE:
;       Result = SPEC_FIT(X, Y, Weights, A, SIGMA, FUNCTION_NAME = name, $
...
;       Flag :  If 0=failed to converge,  if 1=Solution maybe found.
;
; COMMON BLOCKS:
;       NONE.
;
